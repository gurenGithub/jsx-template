...
function render(vnode, container) {
    ...
    let result = container.appendChild(dom);
...
const Dom = {
    render(vnode, container) {
        container.innerHTML = '';
        let result = render(vnode, container);
        mounted(vnode);
        return result;
    },
    insertBefore(vnode, container) {


    },
    insertAfter(vnode, container) {


    },
    insertLast(vnode, container) {
